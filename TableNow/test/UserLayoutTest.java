...
import com.tablenow.UserLayout;
...
public class UserLayoutTest {
	...
	@Test
	  public void onCreatTest() throws Exception {
		UserLayout activity = Robolectric.buildActivity(UserLayout.class).create().get();
	...
	@Test
	  public void onOptionsItemSelectedTest() throws Exception {
		...
		assertThat(shadowIntent.getComponent().getClassName(), equalTo(UserLayout.class.getName()));
	  }
